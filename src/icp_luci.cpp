...
public:
  ICP()
    : Node("icp_luci_node"), init_translation_("0,0,0"),
      init_rotation_("1,0,0;0,1,0;0,0,1")
  {
    ...
    reference_occupancy_grid_subscriber_ =
      create_subscription<nav_msgs::msg::OccupancyGrid>(
        "reference_occupancy_grid", 10,
        std::bind(&ICP::reference_occupancy_grid_callback, this, _1));
    luci_occupancy_grid_subscriber_ =
      create_subscription<nav_msgs::msg::OccupancyGrid>(
        "map", 10, std::bind(&ICP::luci_occupancy_grid_callback, this, _1));
    ...
    luci_occupancy_grid_ = std::make_shared<nav_msgs::msg::OccupancyGrid>();
    reference_occupancy_grid_ =
      std::make_shared<nav_msgs::msg::OccupancyGrid>();
    transformed_occupancy_grid_ =
      std::make_shared<nav_msgs::msg::OccupancyGrid>();
  }

private:
  void luci_occupancy_grid_callback(
    const nav_msgs::msg::OccupancyGrid::SharedPtr msg)
  {
    luci_occupancy_grid_ = msg;
  }
  void reference_occupancy_grid_callback(
    const nav_msgs::msg::OccupancyGrid::SharedPtr msg)
  {
    reference_occupancy_grid_ = msg;
  }
  ...
  // }
  // void
  // data_point_cloud_callback(const sensor_msgs::msg::PointCloud2::SharedPtr
  // msg)
  // {
  //   pcl::fromROSMsg(*msg, data_pcl_cloud_);
  //   data_pcl_cloud_ = *filter_point_cloud(data_pcl_cloud_.makeShared());
  //   luci_occupancy_grid_ = point_cloud_to_occupancy_grid(
  ...
  void match_point_cloud()
  {
    ...
    data_og_cloud_ptr = occupancy_grid_to_2d_point_cloud(luci_occupancy_grid_);
    ...
    transformed_occupancy_grid_ = point_cloud_to_occupancy_grid(
      std::make_shared<pcl::PointCloud<pcl::PointXYZ>>(transformed_pcl_cloud_));
  ...
  void timer_callback()
  {
    ...
    transformed_occupancy_grid_publisher_->publish(
      *transformed_occupancy_grid_);
  ...
  nav_msgs::msg::OccupancyGrid::SharedPtr transformed_occupancy_grid_;
  nav_msgs::msg::OccupancyGrid::SharedPtr luci_occupancy_grid_;
